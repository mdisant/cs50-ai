...
def transition_model(corpus, page, damping_factor):
    ...
    if num_links:            
        ...
        for link in corpus[page]:
            prob_distribution[link] += damping_factor / num_links
    else:
        for link in corpus:
...
def sample_pagerank(corpus, damping_factor, n):
    ...
    for i in range(1, n):
        ...
        for page in prob_distribution:
            prob_distribution[page] = ((i-1) * prob_distribution[page] + current_distribution[page]) / i
        
        page = random.choices(list(prob_distribution.keys()), list(prob_distribution.values()), k=1)[0]
