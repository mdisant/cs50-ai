...
def get_model():
    ...
    # Add an output layer with `NUM_CATEGORIES` units (43 in this case) and 'softmax' activation function
    model.add(tf.keras.layers.Dense(NUM_CATEGORIES, activation='softmax'))

    # Compile the model with an appropriate loss function, optimizer, and metric
